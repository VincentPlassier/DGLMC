...
path_workdir = '/gpfs/workdir/plassierv/22-fed_avg-neurips/' + args.method + '_results/' if '/gpfs/users/plassierv' in path else '/home/cloud/workdir/' + args.method + '_results/'
